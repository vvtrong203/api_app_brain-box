            ...
            modelBuilder.Entity("BrainBoxAPI.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CommentId = 1,
                            Content = "Học android rất là hay luôn",
                            CreatedAt = 1748720800000L,
                            DocDetailId = 1,
                            UserId = 2
                        },
                        ...
                        {
                            CommentId = 2,
                            Content = "đỡ tốn tiền học trung tâm",
                            CreatedAt = 1748720800000L,
                            DocDetailId = 1,
                            UserId = 4
                        },
                        ...
                        {
                            CommentId = 3,
                            Content = "Ảnh bị sao vậy sao không hiển thị",
                            CreatedAt = 1748720800000L,
                            DocDetailId = 1,
                            UserId = 5
                        },
                        ...
                        {
                            CommentId = 4,
                            Content = "có 20 trang thôi à, thêm đi",
                            CreatedAt = 1748720800000L,
                            DocDetailId = 2,
                            UserId = 3
                        });
            ...
            modelBuilder.Entity("BrainBoxAPI.Models.Document", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            DocId = 3,
                            AuthorId = 1,
                            Content = "Tài liệu cung cấp kiến thức cơ bản về cấu trúc và chức năng của tế bào.",
                            CreatedAt = 1748720800000L,
                            IsPublic = true,
                        ...
                        new
                        {
                            DocId = 4,
                            AuthorId = 3,
                            Content = "Tổng hợp truyện cổ tích, ca dao, tục ngữ đặc sắc trong kho tàng dân gian.",
                            CreatedAt = 1748720800000L,
                            IsPublic = true,
                        ...
                        new
                        {
                            DocId = 5,
                            AuthorId = 4,
                            Content = "Trình bày khí hậu, địa hình, sông ngòi và vùng miền trên lãnh thổ Việt Nam.",
                            CreatedAt = 1748720800000L,
                            IsPublic = true,
                        ...
                        new
                        {
                            DocId = 6,
                            AuthorId = 2,
                            Content = "Tìm hiểu về các hành tinh, vệ tinh và hiện tượng thiên văn cơ bản.",
                            CreatedAt = 1748720800000L,
                            IsPublic = true,
                            Title = "Hệ mặt trời",
                            Views = 19
                        ...
                        new
                        {
                            DocId = 7,
                            AuthorId = 1,
                            Content = "Phân tích các cuộc cách mạng lớn: Anh, Mỹ, Pháp và ảnh hưởng của chúng.",
                            CreatedAt = 1748720800000L,
                            IsPublic = true,
                            Title = "Các cuộc cách mạng tư sản",
                            Views = 16
                        },
                        new
                        {
                            DocId = 8,
                            AuthorId = 3,
                            Content = "Khám phá cấu trúc, phân loại và vai trò của thực vật trong tự nhiên.",
                            CreatedAt = 1748720800000L,
                            IsPublic = true,
                            Title = "Thực vật học",
                            Views = 20
                        ...
                        new
                        {
                            DocId = 9,
                            AuthorId = 4,
                            Content = "Tài liệu nội bộ nghiên cứu tâm lý học sinh trong quá trình học tập.",
                            CreatedAt = 1748720800000L,
                            IsPublic = false,
                        ...
                        new
                        {
                            DocId = 10,
                            AuthorId = 2,
                            Content = "Tài liệu chuyên sâu về hành vi người tiêu dùng và doanh nghiệp trong thị trường.",
                            CreatedAt = 1748720800000L,
                            IsPublic = false,
            ...
            modelBuilder.Entity("BrainBoxAPI.Models.Quiz", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedAt = 1748720800000L,
                            CreatorId = 2,
                            Description = "Câu hỏi về quốc gia, thủ đô và danh lam thắng cảnh",
                            IsPublic = true,
                            QuizName = "Địa lý thế giới"
                        },
                        new
                        {
                            QuizId = 4,
                            CreatedAt = 1748720800000L,
                            CreatorId = 4,
                            Description = "Kiến thức nền tảng về cơ học và nhiệt học",
                            IsPublic = true,
                            QuizName = "Vật lý cơ bản"
                        },
                        new
                        {
                            QuizId = 5,
                            CreatedAt = 1748720800000L,
                            CreatorId = 3,
                            Description = "Các sự kiện và nhân vật lịch sử nổi bật",
                            IsPublic = true,
                            QuizName = "Lịch sử Việt Nam"
                        },
                        new
                        {
                            QuizId = 6,
                            CreatedAt = 1748720800000L,
                            CreatorId = 5,
                            Description = "Câu hỏi về tế bào, di truyền và hệ sinh thái",
                            IsPublic = true,
                            QuizName = "Sinh học nhập môn"
                        },
                        new
                        {
                            QuizId = 7,
                            CreatedAt = 1748720800000L,
                            CreatorId = 2,
                            Description = "Bài đọc kèm câu hỏi theo chuẩn IELTS",
                            IsPublic = true,
                            QuizName = "Luyện đọc IELTS"
                        },
                        new
                        {
                            QuizId = 8,
                            CreatedAt = 1748720800000L,
                            CreatorId = 4,
                            Description = "Thuật ngữ và khái niệm cơ bản trong CNTT",
                            IsPublic = true,
                            QuizName = "Thuật ngữ tin học"
                        },
                        new
                        {
                            QuizId = 9,
                            CreatedAt = 1748720800000L,
                            CreatorId = 3,
                            Description = "Nhận diện chữ cái Hiragana cơ bản",
                            IsPublic = false,
                            QuizName = "Hiragana tiếng Nhật"
                        },
                        new
                        {
                            QuizId = 10,
                            CreatedAt = 1748720800000L,
                            CreatorId = 5,
                            Description = "Câu hỏi rèn luyện khả năng suy luận logic",
                            IsPublic = false,
                            QuizName = "Tư duy logic"
                        });
                });
            ...
            modelBuilder.Entity("BrainBoxAPI.Models.Tag", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TagId = 8,
                            Description = "kinh tế học vĩ mô, kinh tế học vi mô",
                            TagName = "Kinh tế"
                        },
                        new
                        {
                            TagId = 9,
                            Description = "Vật lý học tổng quát",
                            TagName = "Vật lý"
                        },
                        new
                        {
                            TagId = 10,
                            Description = "Cơ học lượng tử, lý thuyết xuyên qua không thời gian",
                            TagName = "Xuyên không học"
                        });
                });
